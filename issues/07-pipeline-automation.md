...
- [ ] Workflow steps: set up Python, install dependencies (`requests`, `yfinance`, `beautifulsoup4`), run the data script, and commit `data/market_data.json` back to the repository.
